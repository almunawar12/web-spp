...
<body class="bg-gradient-success">
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-7 col-lg-8 col-md-12 my-3 mx-2">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <div class="text-center">
                    <a class="small text-success" href="index.php#register">Buat Akun Baru</a>
                  </div>
                   <div class="text-center">
                    <a class="small text-success" href="index.php">Kembali Ke Halaman Utama</a>
                  </div>
                </div>
              </div>
            </div>
