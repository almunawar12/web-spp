<?php
$nama_file = "daftar siswa.docx";
header ("content-type:aplication/vnd.ms-word");
header ("expires:0");
header ("cache-control:must-rivalidate,post check=0,pre-check=0");
header ("content-disponsition:attachment;filename=".$nama_file);
...
<p>&nbsp;</p>
<p>&nbsp;<?php echo $totalRows_Recordset1 ?> 
<!-- #BeginDate format:fEn2m -->Thursday 13-Feb-2020  12:10<!-- #EndDate -->
</p>
</body>
</html>
<?php
